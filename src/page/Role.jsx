        ...
        <div className="flex capitalize justify-stretch items-stretch bg-gray-50 w-3/12 ">
          ...
          <div className="w-5/12  text-lg flex flex-row space-x-1 items-stretch my-auto justify-center h-auto">
            <div className="w-full flex justify-center items-center">
              <a
                href={"/role/" + item.id}
                className="bg-gray-300 w-11/12 h-full rounded-lg  font-bold  transition ease-in-out duration-75 hover:-translate-y-1 hover:scale-110 text-black text-center"
              >
                Detials
              </a>
            </div>
...
export function EditableGetRoleComponentMobile({ item, index }) {
  return (
    <Fragment key={"mobile-form-row" + index}>
      <div
        key={index + "-mobile"}
        className="w-full bg-slate-50 text-sm shadow-xl rounded-xl p-2 flex space-y-1 flex-col items-stretch justify-center"
      >
        <div className="w-full flex flex-row justify-center">
          <div className="flex justify-center items-center w-4/12 bg-gray-200 p-1">
            ID{" "}
          </div>
        ...
        <div className="w-full flex flex-row justify-center">
          <div className="flex justify-center items-center w-4/12 p-1 bg-gray-200">
            Name{" "}
          </div>
          <div className="flex justify-center text-ellipsis text-nowrap overflow-hidden items-center w-8/12 p-1 break-all bg-gray-300">
            {item?.name}{" "}
          </div>
        </div>
        <div className="w-full flex flex-row justify-center">
          ...
          <div className="flex justify-center text-ellipsis text-nowrap overflow-hidden items-center w-8/12 break-all p-1 bg-gray-300 indent-3">
            {item?.description}
          </div>
        </div>
        <div className="w-full flex flex-row justify-center">
          ...
          <div className="flex justify-center items-center w-8/12 p-1 capitalize bg-gray-300 indent-3">
        ...
        <div className="w-full flex flex-row justify-center">
          <a
            href={`/role/${item.id}`}
            className="bg-gray-300 w-10/12 h-10 py-2  text-lg font-bold rounded-lg transition ease-in-out duration-75 hover:-translate-y-1 hover:scale-110 text-black text-center"
          >
            Detials
          </a>
        </div>
              ...
              <div className="flex flex-col md:flex-row space-x-2 w-full">
                ...
                <div className="w-full flex flex-col items-end">
                  <div className="w-full sm:w-3/12">
                    <NormalButton label="Add Role" handleClick={handleClick} />
                  </div>
                </div>
              </div>
            </form>
...
export function RolePage() {
  ...
  return page_check ? (
    <div className={myContainer}>
          ...
          <div className="stats mx-10 w-full overflow-hidden shadow">
            ...
            <div className="stat">
              ...
              <div className="stat-value ">
                {activePercentage() != "NaN" ? activePercentage() + "%" : ""}{" "}
              </div>
      ...
      <ErrorBoundary>
        <div
          className={`bg-zinc-100 h-auto ${
            feature_check ? "" : "hidden"
          } shadow-lg w-full text-sm`}
        >
          <AddRolesForm />
        </div>
      </ErrorBoundary>
              ...
              <div className="w-full h-full flex flex-row items-stretch justify-end">
                <div className="flex justify-center items-center w-10/12 sm:w-3/12 ">
                  <input
                    ...
                    maxLength="50"
                    className="rounded-lg w-9/12 text-black"
                  ...
                  {renderData?.map((x, index) => {
                    return (
                      <Fragment key={"mobile-one" + index}>
                        <EditableGetRoleComponentMobile
                          item={x}
                          index={index}
                        />
                      </Fragment>
...
export function ActivateRoleButton({ role_id }) {
  ...
  return (
    <div className="flex w-full sm:w-8/12 justify-center items-center">
      <button
        className="bg-gray-400 w-10/12 h-10 text-xl font-bold rounded-lg transition ease-in-out duration-75 hover:-translate-y-1 hover:scale-110 text-green-700"
...
export function DeactivateRoleButton({ role_id }) {
  ...
  return (
    <div className="flex w-full sm:w-8/12 justify-center items-center">
      <button
        className="bg-gray-400 w-10/12 h-10 text-xl font-bold rounded-lg transition ease-in-out duration-75 hover:-translate-y-1 hover:scale-110 text-red-700"
...
export function AddFeatureToRoleForm({ role_id }) {
  ...
  return (
    <Fragment>
      <div
        className={` flex w-full content-center items-center justify-center h-full ${
          feature_check ? "" : "hidden"
        }`}
      >
            ...
            <form className="p-5 w-full bg-sky-50 rounded-lg ">
              ...
              <div className="flex flex-col md:flex-row space-x-2 w-full">
                ...
                <div className="w-full flex flex-row justify-end items-end">
                  <NormalButton label="Add Feature" handleClick={handleClick} />
                </div>
              </div>
            </form>
          </div>
  ...
  return (
    <Fragment>
      <div
        className={`${
          feature_check ? "" : "hidden"
        } flex w-full content-center items-center justify-center h-full`}
      >
        <div className="flex flex-col items-center justify-center min-w-0 break-words w-full rounded-lg  border-0">
          <div className="w-full  flex-auto px-4 lg:px-10 py-10 pt-0">
            <form className="p-5 w-full bg-sky-50 rounded-lg ">
              ...
              <div className="flex flex-col md:flex-row space-x-2 w-full">
                <div></div>
                <div className="w-full flex flex-row justify-end items-end">
                  <NormalButton label="Add" handleClick={handleClick} />
                </div>
              </div>
            </form>
          </div>
    ...
    return (
      <Fragment key={"form-row" + item.id}>
        <div
          className={
            !edit
              ? "w-full  text-sm flex flex-row space-x-1 items-stretch justify-center h-auto"
              : "hidden"
          }
        >
          ...
          <div className="flex justify-center capitalize items-center bg-gray-50 w-3/12 ">
            ...
            <div
              className={`${
                feature_check ? "" : "hidden"
              } w-5/12  text-lg flex flex-row space-x-1 items-stretch my-auto justify-center h-auto`}
            >
              <div className="w-full flex justify-center items-center">
        ...
        <div
          className={
            !edit
              ? "w-full py-1  text-sm flex flex-row space-x-1 items-stretch justify-center h-auto"
              : "hidden"
          }
        >
        ...
        <ErrorBoundary>
          <div
            className={
              edit
                ? "w-full  text-lg flex flex-row space-x-1 items-stretch justify-center h-auto"
                : "hidden"
            }
          >
            <div className="flex bg-gray-50 w-1/12 justify-center items-center">
        ...
        <div role="tablist" className="tabs tabs-lifted w-full">
          <a
            name="my_tabs_2"
            onClick={() => setTabToken(1)}
            role="tab"
            className={`tab ${
              tabToken == 1 ? "tab-active" : ""
            } [--tab-bg:white] [--tab-border-color:black]`}
            aria-label="UseCases"
          >
            {" "}
            UseCases{" "}
          ...
          <div
            role="tabpanel"
            className="tab-content  bg-gray-200  border-base-300 rounded-box p-6"
          >
              ...
              <div className="flex flex-row flex-wrap m-1 items-stretch justify-start min-w-0 break-words w-full border-0 p-2">
                <div className="max-w-sm rounded m-1 overflow-hidden  bg-blue-100 shadow-lg">
                  <div className="px-6 py-4">
                    <div className="font-bold text-xl mb-2">
                      Updating Role Attribute
                    </div>
                    <p className="text-gray-700 text-base">
                      Updating role included changing description and status,and
                      which app the role belongs to.
                    </p>
                  </div>
                ...
                <div className="max-w-sm rounded m-1 overflow-hidden bg-blue-100 shadow-lg">
                  <div className="px-6 py-4">
                    ...
                    <p className="text-gray-700 text-base">
                      If Role is Disabled "True"; the user with this specfic
                      role will not be able to access endpoints asscocaited with
                      the role.
                    </p>
                  </div>
                  <div className="px-6 pt-4 pb-2">
                ...
                <div className="max-w-sm rounded m-1 overflow-hidden bg-blue-100 shadow-lg">
                  <div className="px-6 py-4">
                    ...
                    <p className="text-gray-700 text-base">
                      As long as the attached feature is active;Role will have
                      Access to Operations on Endpoints grouped with te feature.
                    </p>
                  </div>
                  <div className="px-6 pt-4 pb-2">
                    <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
          ...
          <a
            name="my_tabs_2"
            onClick={() => setTabToken(2)}
            role="tab"
            className={`tab ${
              tabToken == 2 ? "tab-active" : ""
            } [--tab-bg:white] [--tab-border-color:black]`}
            aria-label="Features"
          >
            {" "}
          ...
          <div
            role="tabpanel"
            className="tab-content bg- bg-gray-200  border-base-300 rounded-box p-6"
          >
            <ErrorBoundary>
              <div className="w-full  bg-gray-50 text-lg flex flex-row flex-wrap items-stretch justify-start h-auto">
                ...
                <div className="w-full flex  items-center justify-center bg-gray-50 font-bold text-xl">
                  <p>Features Asscociated With this Role</p>
                </div>
                {item?.features?.map((feature, index) => {
                  return (
                    <div
                      key={index + feature?.name}
                      className="flex w-4/12 rounded-2x  p-1 break-all bg-slate-50 rounded-tl-lg flex-row justify-start items-stretch"
                    >
                      ...
                      <div
                        className={`${
                          feature_check ? "" : "hidden"
                        } w-2/12 flex items-center justify-center bg-slate-300`}
                      >
                        <ErrorBoundary>
                          <DeleteRoleFeatureButton
          ...
          <a
            name="my_tabs_2"
            onClick={() => setTabToken(3)}
            role="tab"
            className={`tab ${tabToken == 3 ? "tab-active" : ""} ${
              feature_check ? "" : "hidden"
            } [--tab-bg:white] [--tab-border-color:black]`}
          ...
          <a
            name="my_tabs_2"
            onClick={() => setTabToken(4)}
            role="tab"
            className={`tab ${tabToken == 4 ? "tab-active" : ""} ${
              feature_check ? "" : "hidden"
            }  [--tab-bg:white] [--tab-border-color:black]`}
            ...
            <ErrorBoundary>
              <div className="w-full  bg-gray-50 text-lg flex flex-row flex-wrap items-stretch justify-start h-auto">
                ...
                <div className="w-full flex  items-center justify-center bg-sky-50 font-bold text-xl">
                  <p>Endpoints that can be accesed with this Role</p>
                </div>
                {endpoints?.map((endpoint, index) => {
                  return (
                    <div
                      key={index + endpoint?.name}
                      className="flex w-3/12 p-1 break-all bg-slate-50 rounded-tl-lg flex-row justify-start items-stretch"
                    >
          ...
          <a
            name="my_tabs_2"
            onClick={() => setTabToken(5)}
            role="tab"
            className={`tab ${tabToken == 5 ? "tab-active" : ""} ${
              feature_check ? "" : "hidden"
            } [--tab-bg:white] [--tab-border-color:black] `}
            aria-label="App"
          >
  ...
  if (item != null) {
    return (
      <Fragment key={"mobile-form-row" + item?.id}>
        ...
        <div
          key={item?.id + "-mobile"}
          className="w-full bg-slate-50 shadow-xl rounded-xl p-2 flex space-y-1 flex-col items-stretch justify-center"
        >
          <div
            className={
              !edit
                ? "w-full bg-slate-50 shadow-xl rounded-xl p-2 flex space-y-1 flex-col items-stretch justify-center"
                : "hidden"
            }
          >
            <div className="w-full flex flex-row justify-center">
            ...
            <div className="w-full flex flex-row justify-center">
              ...
              <div className="flex justify-center items-center text-ellipsis text-nowrap overflow-hidden w-8/12 p-1 break-all bg-gray-300">
                {item?.name}{" "}
              </div>
            </div>
            <div className="w-full flex flex-row justify-center">
              ...
              <div className="flex justify-center items-center  w-8/12 break-all p-1 bg-gray-300 indent-3">
                {item?.description}
              </div>
            </div>
            <div className="w-full flex flex-row justify-center">
          ...
          <div
            className={
              view ? "w-full  flex flex-auto justify-center" : "hidden"
            }
          >
            <div role="tablist" className="tabs tabs-lifted w-full">
              <a
                  ...
                  <div className="flex flex-row flex-wrap m-1 items-stretch justify-start min-w-0 break-words w-full border-0 p-2">
                    <div className="max-w-sm rounded m-1 overflow-hidden  bg-blue-100 shadow-lg">
                      <div className="px-6 py-4">
                        ...
                        <p className="text-gray-700 text-base">
                          Updating role included changing description and
                          status,and which app the role belongs to.
                        </p>
                      </div>
                      <div className="px-6 pt-4 pb-2">
                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
                    ...
                    <div className="max-w-sm rounded m-1 overflow-hidden bg-blue-100 shadow-lg">
                      <div className="px-6 py-4">
                        ...
                        <p className="text-gray-700 text-base">
                          If Role is Disabled "True"; the user with this specfic
                          role will not be able to access endpoints asscocaited
                          with the role.
                        </p>
                      </div>
                      <div className="px-6 pt-4 pb-2">
                    ...
                    <div className="max-w-sm rounded m-1 overflow-hidden bg-blue-100 shadow-lg">
                      <div className="px-6 py-4">
                        ...
                        <p className="text-gray-700 text-base">
                          As long as the attached feature is active;Role will
                          have Access to Operations on Endpoints grouped with te
                          feature.
                        </p>
                      </div>
                      <div className="px-6 pt-4 pb-2">
                  ...
                  <div className="w-full  bg-gray-50 text-lg flex flex-row flex-wrap items-stretch justify-start h-auto">
                    ...
                    {item?.features?.map((feature, index) => {
                      return (
                        <div
                          key={index + feature?.name}
                          className="flex w-4/12 p-1 break-all bg-slate-50 rounded-tl-lg flex-row justify-start items-stretch"
                        >
                          <div className="w-10/12 text-sm text-nowrap  overflow-hidden  text-ellipsis bg-sky-100 break-all p-1 flex items-center justify-center">
                            <p className="text-ellipsis">{feature?.name}</p>
                          </div>
          ...
          <div className="w-full flex items-stretch  justify-start h-auto  ">
            <div className="flex flex-col space-y-2  items-center justify-start min-w-0 break-words w-full shadow-lg rounded-lg bg-gray-200 border-0 pt-5 ">
              ...
              <div className="mobile-block md:hidden w-full flex-auto px-4 lg:px-10 py-10 pt-0">
                <div className="w-full flex flex-col items-stretch h-auto space-y-1">
                  <ErrorBoundary>
                    <EditableSingleRoleComponentMobile
                      id={id}
                      endpoints={endpoints}
                    />
                  </ErrorBoundary>
